...
AllowedDOF :: bit_set[SixDOFConstraintAxis]

PLANE_2D: AllowedDOF : {.TranslationX, .TranslationY, .RotationZ}
ALL_DOF: AllowedDOF : ~{}
...
DrawSettings :: struct {
    getSupportFunction:        bool, ///< Draw the GetSupport() function, used for convex collision detection
    supportDirection:          bool, ///< When drawing the support function, also draw which direction mapped to a specific support point
    getSupportingFace:         bool, ///< Draw the faces that were found colliding during collision detection
    shape:                     bool, ///< Draw the shapes of all bodies
    shapeWireframe:            bool, ///< When mDrawShape is true and this is true, the shapes will be drawn in wireframe instead of solid.
    shapeColor:                BodyManager_ShapeColor, ///< Coloring scheme to use for shapes
    boundingBox:               bool, ///< Draw a bounding box per body
    centerOfMassTransform:     bool, ///< Draw the center of mass for each body
    worldTransform:            bool, ///< Draw the world transform (which may differ from its center of mass) of each body
    velocity:                  bool, ///< Draw the velocity vector for each body
    massAndInertia:            bool, ///< Draw the mass and inertia (as the box equivalent) for each body
    sleepStats:                bool, ///< Draw stats regarding the sleeping algorithm of each body
    softBodyVertices:          bool, ///< Draw the vertices of soft bodies
    softBodyVertexVelocities:  bool, ///< Draw the velocities of the vertices of soft bodies
    softBodyEdgeConstraints:   bool, ///< Draw the edge constraints of soft bodies
    softBodyBendConstraints:   bool, ///< Draw the bend constraints of soft bodies
    softBodyVolumeConstraints: bool, ///< Draw the volume constraints of soft bodies
    softBodySkinConstraints:   bool, ///< Draw the skin constraints of soft bodies
    softBodyLRAConstraints:    bool, ///< Draw the LRA constraints of soft bodies
    softBodyPredictedBounds:   bool, ///< Draw the predicted bounds of soft bodies
    softBodyConstraintColor:   SoftBodyConstraintColor, ///< Coloring scheme to use for soft body constraints
}
...
ShapeFilter_Procs :: struct {
    ...
    ShouldCollide2: proc "c" (_: rawptr, _: ^Shape, _: ^SubShapeID, _: ^Shape, _: ^SubShapeID) -> bool,
}
...
ContactListener_Procs :: struct {
    OnContactValidate:  proc "c" (_: rawptr, _: ^Body, _: ^Body, _: ^RVec3, _: ^CollideShapeResult) -> ValidateResult,
    OnContactAdded:     proc "c" (_: rawptr, _: ^Body, _: ^Body, _: ^ContactManifold, _: ^ContactSettings),
    OnContactPersisted: proc "c" (_: rawptr, _: ^Body, _: ^Body, _: ^ContactManifold, _: ^ContactSettings),
...
CharacterContactListener_Procs :: struct {
    OnAdjustBodyVelocity:        proc "c" (_: rawptr, _: ^CharacterVirtual, _: ^Body, _: ^Vec3, _: ^Vec3),
    OnContactValidate:           proc "c" (_: rawptr, _: ^CharacterVirtual, _: BodyID, _: SubShapeID) -> bool,
    ...
    OnContactRemoved:            proc "c" (_: rawptr, _: ^CharacterVirtual, _: BodyID, _: SubShapeID),
    ...
    OnCharacterContactRemoved:   proc "c" (_: rawptr, _: ^CharacterVirtual, _: CharacterID, _: SubShapeID),
...
CharacterVsCharacterCollision_Procs :: struct {
    CollideCharacter: proc "c" (_: rawptr, _: ^CharacterVirtual, _: ^RMatrix4x4, _: ^CollideShapeSettings, _: ^RVec3),
...
DebugRenderer_Procs :: struct {
    ...
    DrawTriangle: proc "c" (_: rawptr, _: ^RVec3, _: ^RVec3, _: ^RVec3, _: Color, _: DebugRenderer_CastShadow),
...
foreign lib {
    ...
    BodyCreationSettings_GetAllowedDOFs :: proc(settings: ^BodyCreationSettings) -> AllowedDOF ---
    BodyCreationSettings_SetAllowedDOFs :: proc(settings: ^BodyCreationSettings, value: AllowedDOF) ---
    ...
    //--------------------------------------------------------------------------------------------------
    MotionProperties_GetAllowedDOFs :: proc(properties: ^MotionProperties) -> AllowedDOF ---
    ...
    MotionProperties_SetMassProperties :: proc(properties: ^MotionProperties, allowedDOFs: AllowedDOF, massProperties: ^MassProperties) ---
